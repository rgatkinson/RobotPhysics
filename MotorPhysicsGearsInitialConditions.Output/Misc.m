...
motorParameters[motorData_, motorName_, opts:OptionsPattern[]] := 
    validateOptions[][Module[{row, paramValues, keQuants, ktQuants, quantify, 
       qty, assoc}, row = Select[motorData, #1[[1]] == motorName & ][[1]]; 
       paramValues = (#1[[1]] -> toRational[row[[#1[[2]]]]] & ) /@ 
         {{R, 2}, {L, 4}, {KeWithGearbox, 5}, {KtWithGearbox, 6}, 
          {KeNoGearbox, 7}, {KtNoGearbox, 8}, {J, 9}, {B, 10}, 
          {\[CapitalNu], 11}, {\[Eta], If[OptionValue[Efficiency] == 
             "Forward", 12, 13]}}; keQuants = 
        (#1 -> Quantity[#1, QuantityUnit[Ke /. parameterQuantities]] & ) /@ 
         {KeWithGearbox, KeNoGearbox}; ktQuants = 
        (#1 -> Quantity[#1, QuantityUnit[Kt /. parameterQuantities]] & ) /@ 
         {KtWithGearbox, KtNoGearbox}; quantify = Function[{name, value}, 
         qty = name /. parameterQuantities /. keQuants /. ktQuants; 
       ...
       assoc[\[CapitalDelta]\[Tau]appConst] = Quantity[0, siTorqueUnits]; 
       If[OptionValue[WithGearbox], assoc[Ke] = assoc[KeNoGearbox]; 
         assoc[Kt] = assoc[KtNoGearbox]; , assoc[\[CapitalNu]] = 1; 
         assoc[\[Eta]] = 1; assoc[Ke] = assoc[KeWithGearbox]; 
         assoc[Kt] = assoc[KtWithGearbox]; ]; assoc[KeWithGearbox] =. ; 
       assoc[KtWithGearbox] =. ; assoc[KeNoGearbox] =. ; 
       assoc[KtNoGearbox] =. ; simplifyUnits[siUnits[assoc]]]]
...
applyTimeFunction[Function[{vappfn$, \[Tau]appfn$}, 
      Module[{fn$}, fn$ = makeTimeDomainFunctionConvolve[
        ...
        fn$]], <|R -> 3.3, L -> 0.000694, J -> 0.00001041, B -> 0.033, 
      \[CapitalNu] -> 1., \[Eta] -> 1., Jafter -> 0.0096, Bafter -> 0., 
      \[CapitalDelta]\[Tau]appConst -> 0., Ke -> 1.066, Kt -> 1.066|>, 
     <|t -> t, vapp0 -> 0., \[Tau]app0 -> 0., \[CapitalDelta]vappConst -> 
       12.|>, t] = {{{10.272586520362115 + 0.08685804310541263/
         E^(4718.9116176050775*t) - 10.359444563467527/
         E^(39.56538655923656*t)}}, 
     {{10.272586520362115 + 0.08685804310541263/E^(4718.9116176050775*t) - 
        10.359444563467527/E^(39.56538655923656*t)}}}
      ...
      Module[{fn$}, fn$ = makeTimeDomainFunctionConvolve[
          TransferFunctionModel[{{{\[CapitalNu]*(Kt*vapp0*\[Eta]*
           ...
           SystemsModelLabels -> {{"1", "vapp", "\[Tau]app"}, "\[Omega]", 
             Automatic}], {1 & , vappfn$[#1] & , \[Tau]appfn$[#1] & }]; 
        fn$]], <|R -> 3.3, L -> 0.000694, J -> 0.00001041, B -> 0.033, 
      \[CapitalNu] -> 60., \[Eta] -> 0.9, Jafter -> 0.0096, Bafter -> 0., 
      \[CapitalDelta]\[Tau]appConst -> 0., Ke -> 0.017766666666666667, 
      Kt -> 0.017766666666666667|>, <|t -> t, vapp0 -> 0., \[Tau]app0 -> 0., 
      \[CapitalDelta]vappConst -> 12.|>, t] = 
    {{{1.9521011075243806 + 2.14683116735248/E^(4740.076116086594*t) - 
        4.09893227487686/E^(2482.632661195531*t)}}, 
     {{1.9521011075243806 + 2.14683116735248/E^(4740.076116086594*t) - 
        4.09893227487686/E^(2482.632661195531*t)}}}
...
applyTimeFunction[Function[{vappfn$, \[Tau]appfn$}, 
      ...
      Ke -> Quantity[533/500, ("Kilograms"*"Meters"^2)/("Amperes"*"Radians"*
         ...
         ("Amperes"*"Radians"*"Seconds"^2)]|>, <|t -> Quantity[t, "Seconds"], 
      vapp0 -> Quantity[0, "Volts"], \[Tau]app0 -> 
       Quantity[0, ("Meters"*"Newtons")/"Radians"], 
...
applyTimeFunction[Function[{vappfn$, \[Tau]appfn$}, 
      ...
      Ke -> Quantity[533/500, ("Kilograms"*"Meters"^2)/("Amperes"*"Radians"*
          "Seconds"^2)], Kt -> Quantity[533/500, ("Kilograms"*"Meters"^2)/
         ("Amperes"*"Radians"*"Seconds"^2)]|>, <|t -> Quantity[t, "Seconds"], 
      vapp0 -> Quantity[12, "Volts"], \[Tau]app0 -> 
       Quantity[0, ("Meters"*"Newtons")/"Radians"], 
      \[CapitalDelta]vappConst -> Quantity[-12, "Volts"]|>, t] = 
    {{{(1 + E^Quantity[(5000*(-16500286275 + Sqrt[272173025490913197401])*t)/
             34700361227, (Sqrt["Kilograms"]*"Meters")/("Amperes"*
              Sqrt[("Kilograms"*"Meters"^2)/("Amperes"^2*"Seconds"^2)]*
              "Seconds")])*Quantity[0, "Radians"/"Seconds"] + 
        E^Quantity[(-5000*(16500286275 + Sqrt[272173025490913197401])*t)/
            34700361227, (Sqrt["Kilograms"]*"Meters")/("Amperes"*
             Sqrt[("Kilograms"*"Meters"^2)/("Amperes"^2*"Seconds"^2)]*
             "Seconds")]*Quantity[799500/155657 - 13191978876862500/
        ...
        E^Quantity[(5000*(-16500286275 + Sqrt[272173025490913197401])*t)/
            34700361227, (Sqrt["Kilograms"]*"Meters")/("Amperes"*
             ...
             "Seconds")]*Quantity[799500/155657 + 13191978876862500/
            (155657*Sqrt[272173025490913197401]), "Radians"/"Seconds"]}}, 
     {{-0.0008153853405064027/E^(4754.698853616825*t) + 
        10.273401905702585/E^(0.37737370535485504*t)}}}
...
applyTimeFunction[Function[{vappfn$, \[Tau]appfn$}, 
    ...
    {{{(E^Quantity[(5000*(-16500286275 + Sqrt[272173025490913197401])*t)/
             34700361227, (Sqrt["Kilograms"]*"Meters")/("Amperes"*
              Sqrt[("Kilograms"*"Meters"^2)/("Amperes"^2*"Seconds"^2)]*
              "Seconds")] + E^Quantity[(-5000*(16500286275 + Sqrt[
                272173025490913197401])*t)/34700361227, 
            (Sqrt["Kilograms"]*"Meters")/("Amperes"*Sqrt[("Kilograms"*
                 "Meters"^2)/("Amperes"^2*"Seconds"^2)]*"Seconds")])*
         Quantity[0, "Radians"/"Seconds"] + Quantity[1599000/155657, 
         "Radians"/"Seconds"]}}, {{10.272586520362077}}}
 
applyTimeFunction[Function[{vappfn$, \[Tau]appfn$}, 
      Module[{fn$}, fn$ = makeTimeDomainFunctionConvolve[
          TransferFunctionModel[{{{\[CapitalNu]*(Kt*vapp0*\[Eta]*
                 \[CapitalNu] + R*\[Tau]app0), Kt*\[Eta]*\[CapitalNu]^2, 
              (R + L*s)*\[CapitalNu]}}, {{s*(Bafter*R + (Ke*Kt + B*R)*\[Eta]*
                 \[CapitalNu]^2), s*(Ke*Kt*\[Eta]*\[CapitalNu]^2 + 
                (R + L*s)*(Bafter + Jafter*s + (B + J*s)*\[Eta]*\[CapitalNu]^
                    2)), s*(Ke*Kt*\[Eta]*\[CapitalNu]^2 + (R + L*s)*
                 (Bafter + Jafter*s + (B + J*s)*\[Eta]*\[CapitalNu]^2))}}}, 
           s, SystemsModelLabels -> {{"1", "vapp", "\[Tau]app"}, "\[Theta]", 
             Automatic}], {1 & , vappfn$[#1] & , \[Tau]appfn$[#1] & }]; 
        fn$]], <|R -> Quantity[33/10, "Watts"/"Amperes"^2], 
      L -> Quantity[347/500000, "Henries"], 
      J -> Quantity[1041/100000000, ("Kilograms"*"Meters"^2)/"Radians"^2], 
    ...
    {{{E^Quantity[(-5000*(16500286275 + Sqrt[272173025490913197401])*t)/
        ...
        E^Quantity[(5000*(-16500286275 + Sqrt[272173025490913197401])*t)/
           ...
           435273761881969325134287/(1938328131920*
             Sqrt[272173025490913197401]), "Radians"] + 
        Quantity[(7995*(-660011451 + 249051200*t))/193832813192, 
         "Radians"]}}, {{-27.223417252465424 - 1.7149042719211138*^-7/
         E^(4754.698853616825*t) + 27.223417423955848/
         E^(0.37737370535485504*t) + 10.27258652036208*t}}}
 
applyTimeFunction[Function[{vappfn$, \[Tau]appfn$}, 
      Module[{fn$}, fn$ = makeTimeDomainFunctionConvolve[
          TransferFunctionModel[{{{Ke*\[CapitalNu]*(Kt*vapp0*\[Eta]*
                 \[CapitalNu] + R*\[Tau]app0), Ke*Kt*\[Eta]*\[CapitalNu]^2, 
              Ke*(R + L*s)*\[CapitalNu]}}, {{Bafter*R + (Ke*Kt + B*R)*\[Eta]*
                \[CapitalNu]^2, Ke*Kt*\[Eta]*\[CapitalNu]^2 + (R + L*s)*
                (Bafter + Jafter*s + (B + J*s)*\[Eta]*\[CapitalNu]^2), 
              Ke*Kt*\[Eta]*\[CapitalNu]^2 + (R + L*s)*(Bafter + Jafter*s + 
                 (B + J*s)*\[Eta]*\[CapitalNu]^2)}}}, s, 
    ...
    {{{Quantity[1704534/155657, ("Kilograms"*"Meters"^2)/
        ...
        E^Quantity[(-5000*(16500286275 + Sqrt[272173025490913197401])*t)/
            ...
            (155657*Sqrt[272173025490913197401]), ("Kilograms"*"Meters"^2)/
           ("Amperes"*"Seconds"^3)]}}, 
     {{10.950577230705976 + 0.0008692007729775852/E^(4754.698853616825*t) - 
        10.951446431478953/E^(0.37737370535485504*t)}}}
 
applyTimeFunction[Function[{vappfn$, \[Tau]appfn$}, 
      Module[{fn$}, fn$ = makeTimeDomainFunctionConvolve[
          TransferFunctionModel[{{{Bafter*vapp0 + \[CapitalNu]*
                (B*vapp0*\[Eta]*\[CapitalNu] - Ke*\[Tau]app0), 
              Bafter + Jafter*s + (B + J*s)*\[Eta]*\[CapitalNu]^2, 
              -(Ke*\[CapitalNu])}}, {{Bafter*R + (Ke*Kt + B*R)*\[Eta]*
                \[CapitalNu]^2, Ke*Kt*\[Eta]*\[CapitalNu]^2 + (R + L*s)*
                (Bafter + Jafter*s + (B + J*s)*\[Eta]*\[CapitalNu]^2), 
              Ke*Kt*\[Eta]*\[CapitalNu]^2 + (R + L*s)*(Bafter + Jafter*s + 
                 (B + J*s)*\[Eta]*\[CapitalNu]^2)}}}, s, 
           SystemsModelLabels -> {{"1", "vapp", "\[Tau]app"}, "i", 
             Automatic}], {1 & , vappfn$[#1] & , \[Tau]appfn$[#1] & }]; 
        fn$]], <|R -> Quantity[33/10, "Watts"/"Amperes"^2], 
      L -> Quantity[347/500000, "Henries"], 
      J -> Quantity[1041/100000000, ("Kilograms"*"Meters"^2)/"Radians"^2], 
...
applyTimeFunction[Function[{vappfn$, \[Tau]appfn$}, 
    ...
    {{{Quantity[52767/155657, ("Kilograms"*"Meters"^2)/
        ...
        E^Quantity[(5000*(-16500286275 + Sqrt[272173025490913197401])*t)/
            ...
            (1556570*Sqrt[272173025490913197401]), ("Kilograms"*"Meters"^2)/
           ("Radians"*"Seconds"^2)]}}, 
     {{0.33899535517194856 - 3.8769251946905507/E^(4754.698853616825*t) + 
        3.5379298395186023/E^(0.37737370535485504*t)}}}
...
applyTimeFunction[motorTimeFunction_, motorWithLoad_, input_, t_] := 
    applyTimeFunction[motorTimeFunction, motorWithLoad, input, t] = 
     Module[{generic, withUnits, unitless}, 
      generic = applyTimeFunctionGeneric[motorTimeFunction, t]; 
       withUnits = FullSimplify[siUnits[generic /. 
           {Join[input, motorWithLoad]}]]; unitless = 
        FullSimplify[N[clearUnits[withUnits]]]; {withUnits, unitless}]
...
applyTimeFunctionGeneric[Function[{vappfn$, \[Tau]appfn$}, 
      Module[{fn$}, fn$ = makeTimeDomainFunctionConvolve[
          TransferFunctionModel[{{{\[CapitalNu]*(Kt*vapp0*\[Eta]*
                 \[CapitalNu] + R*\[Tau]app0), Kt*\[Eta]*\[CapitalNu]^2, 
              (R + L*s)*\[CapitalNu]}}, {{Bafter*R + (Ke*Kt + B*R)*\[Eta]*
...
applyTimeFunctionGeneric[Function[{vappfn$, \[Tau]appfn$}, 
      Module[{fn$}, fn$ = makeTimeDomainFunctionConvolve[
          TransferFunctionModel[{{{\[CapitalNu]*(Kt*vapp0*\[Eta]*
           ...
           s, SystemsModelLabels -> {{"1", "vapp", "\[Tau]app"}, "\[Theta]", 
             Automatic}], {1 & , vappfn$[#1] & , \[Tau]appfn$[#1] & }]; 
        fn$]], t] = {Kt*\[CapitalDelta]vappConst*\[Eta]*\[CapitalNu]^2*
...
applyTimeFunctionGeneric[Function[{vappfn$, \[Tau]appfn$}, 
      Module[{fn$}, fn$ = makeTimeDomainFunctionConvolve[
          TransferFunctionModel[{{{Ke*\[CapitalNu]*(Kt*vapp0*\[Eta]*
           ...
           SystemsModelLabels -> {{"1", "vapp", "\[Tau]app"}, "vg", 
             Automatic}], {1 & , vappfn$[#1] & , \[Tau]appfn$[#1] & }]; 
        fn$]], t] = {(-2*Ke*Kt*L*\[CapitalDelta]vappConst*\[Eta]*
        \[CapitalNu]^2*(Jafter + J*\[Eta]*\[CapitalNu]^2)*
        ((-1 + E^(-(t*(Bafter*L + Jafter*R + B*L*\[Eta]*\[CapitalNu]^2 + 
                J*R*\[Eta]*\[CapitalNu]^2 - Sqrt[-4*L*(Jafter + J*\[Eta]*
                     \[CapitalNu]^2)*(Bafter*R + (Ke*Kt + B*R)*\[Eta]*
...
applyTimeFunctionGeneric[motorTimeFunction_, t_] := 
    applyTimeFunctionGeneric[motorTimeFunction, t] = 
